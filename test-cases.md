...
|---------------------|--------|-----------------------|-----------|
| 2026-02-20 10:00:00 | USER   | 12:45 call Poly       | call Poly |
...
| Current Time        | Actor  | Input / Expected Next | Message   |
|---------------------|--------|-----------------------|-----------|
| 2026-02-20 14:00:00 | USER   | 12:45 call Poly       | call Poly |
...
| Current Time        | Actor  | Input / Expected Next | Message   |
|---------------------|--------|-----------------------|-----------|
| 2026-02-20 12:45:00 | USER   | 12:45 call Poly       | call Poly |
...
| Current Time        | Actor  | Input / Expected Next | Message   |
|---------------------|--------|-----------------------|-----------|
| 2026-02-20 12:44:59 | USER   | 12:45 call Poly       | call Poly |
...
| Current Time        | Actor  | Input / Expected Next | Message   |
|---------------------|--------|-----------------------|-----------|
| 2026-02-20 00:00:00 | USER   | 12:45 call Poly       | call Poly |
...
| Current Time        | Actor  | Input / Expected Next | Message   |
|---------------------|--------|-----------------------|-----------|
| 2026-02-28 13:00:00 | USER   | 12:45 call Poly       | call Poly |
...
| Current Time        | Actor  | Input / Expected Next          | Message    |
|---------------------|--------|--------------------------------|------------|
| 2026-02-20 10:00:00 | USER   | 15:30 every 3 days run backup  | run backup |
...
| Current Time        | Actor  | Input / Expected Next          | Message    |
|---------------------|--------|--------------------------------|------------|
| 2026-02-20 19:31:00 | USER   | 19:30 every 7 min call Peter   | call Peter |
...
| Current Time        | Actor  | Input / Expected Next       | Message     |
|---------------------|--------|-----------------------------|-------------|
| 2026-02-20 23:59:59 | USER   | 1:34 every year check lease | check lease |
...
| Current Time        | Actor  | Input / Expected Next          | Message        |
|---------------------|--------|--------------------------------|----------------|
| 2026-12-31 23:59:59 | USER   | 1:06 every year happy new year | happy new year |
...
| Current Time        | Actor  | Input / Expected Next          | Message    |
|---------------------|--------|--------------------------------|------------|
| 2026-02-20 23:59:59 | USER   | 20:00 every month run report   | run report |
...
| Current Time        | Actor  | Input / Expected Next            | Message        |
|---------------------|--------|----------------------------------|----------------|
| 2026-02-21 09:00:00 | USER   | 11:26 12.10.2026 call the office | call the office |
...
| Current Time        | Actor  | Input / Expected Next                    | Message   |
|---------------------|---------|-----------------------------------------|-----------|
| 2026-02-21 09:00:00 | USER   | 11:26 12.10.2026 every 2 weeks sync team | sync team |
| 2026-02-21 09:00:00 | SYSTEM | 2026-10-12 11:26:00                      |           |
...
| Current Time        | Actor  | Input / Expected Next   | Message     |
|---------------------|--------|-------------------------|-------------|
| 2026-02-23 09:00:00 | USER   | 10:30 FridaY release day   | release day |
...
| Current Time        | Actor  | Input / Expected Next        | Message       |
|---------------------|--------|------------------------------|---------------|
| 2026-02-19 10:26:00 | USER   | 10:25 mon-fri Daily standup  | Daily standup |
...
| Current Time        | Actor  | Input / Expected Next                        | Message          |
|---------------------|--------|----------------------------------------------|------------------|
| 2026-02-21 09:00:00 | USER   | 13:25 2027 fri,sun new year standup          | new year standup |
...
| Current Time        | Actor  | Input / Expected Next | Message   |
|---------------------|--------|-----------------------|-----------|
| 2026-02-20 07:00:00 | USER   | 8 call Alex           | call Alex |
...
| Current Time        | Actor  | Input / Expected Next | Message   |
|---------------------|--------|-----------------------|-----------|
| 2026-02-20 09:00:00 | USER   | 8 call Alex           | call Alex |
...
| Current Time        | Actor  | Input / Expected Next | Message   |
|---------------------|--------|-----------------------|-----------|
| 2026-02-20 08:00:00 | USER   | 8 call Alex           | call Alex |
...
| Current Time        | Actor  | Input / Expected Next | Message   |
|---------------------|--------|-----------------------|-----------|
| 2026-02-20 10:00:00 | USER   | 24 call Poly          | call Poly |
...
| Current Time        | Actor  | Input / Expected Next     | Message   |
|---------------------|--------|---------------------------|-----------|
| 2026-02-20 10:00:00 | USER   | 21 call Poly every 2 days | call Poly |
...
| Current Time        | Actor  | Input / Expected Next | Message  |
|---------------------|--------|-----------------------|----------|
| 2026-02-20 10:00:00 | USER   | 8 min call her        | call her |
...
| Current Time        | Actor  | Input / Expected Next      | Message        |
|---------------------|--------|----------------------------|----------------|
| 2026-02-20 10:00:00 | USER   | 3 hour check the oven     | check the oven |
...
| Current Time        | Actor  | Input / Expected Next      | Message            |
|---------------------|--------|----------------------------|--------------------|
| 2026-02-20 23:55:00 | USER   | 10 min take the pizza out  | take the pizza out |
...
| Current Time        | Actor  | Input / Expected Next          | Message      |
|---------------------|--------|--------------------------------|--------------|
| 2026-02-20 10:00:00 | USER   | 8 min every hour check server  | check server |
| 2026-02-20 10:00:00 | SYSTEM | 2026-02-20 10:08:00            |              |
...
| Current Time        | Actor  | Input / Expected Next              | Message     |
|---------------------|---------|------------------------------------|------------|
| 2026-02-20 10:00:00 | USER   | 20 hours every 2 weeks sync report | sync report |
...
| Current Time        | Actor  | Input / Expected Next           | Message       |
|---------------------|--------|---------------------------------|---------------|
| 2026-02-20 09:00:00 | USER   | 30 min every day morning water  | morning water |
...
| Current Time        | Actor  | Input / Expected Next              | Message     |
|---------------------|---------|------------------------------------|------------|
| 2026-02-20 10:00:00 | USER   | 10:00 first sunday buy package     | buy package |
...
| Current Time        | Actor  | Input / Expected Next              | Message     |
|---------------------|--------|------------------------------------|-------------|
| 2026-03-01 09:00:00 | USER   | 10:00 first sunday buy package     | buy package |
...
| Current Time        | Actor  | Input / Expected Next              | Message      |
|---------------------|--------|------------------------------------|--------------|
| 2026-02-20 08:00:00 | USER   | 9:30 last monday sell package      | sell package |
...
| Current Time        | Actor  | Input / Expected Next              | Message      |
|---------------------|--------|------------------------------------|--------------|
| 2026-02-28 11:35:00 | USER   | 9:30 last sat sell package         | sell package |
...
| Current Time        | Actor  | Input / Expected Next                  | Message   |
|---------------------|--------|----------------------------------------|-----------|
| 2026-02-05 10:00:00 | USER   | 18:00 last day of the month pay bills  | pay bills |
...
| Current Time        | Actor  | Input / Expected Next          | Message   |
|---------------------|--------|--------------------------------|-----------|
| 2026-02-05 10:00:00 | USER   | 18:00 last day pay bills       | pay bills |
| 2026-02-05 10:00:00 | SYSTEM | 2026-02-28 18:00:00            |           |
| 2026-02-28 18:00:01 | SYSTEM | 2026-03-31 18:00:00            |           |
...
| Current Time        | Actor  | Input / Expected Next                  | Message   |
|---------------------|--------|----------------------------------------|-----------|
| 2026-02-28 17:00:00 | USER   | 18:00 last day of the month pay bills  | pay bills |
...
| Current Time        | Actor  | Input / Expected Next                  | Message   |
|---------------------|--------|----------------------------------------|-----------|
| 2026-02-28 19:00:00 | USER   | 18:00 last day of the month pay bills  | pay bills |
...
| Current Time        | Actor  | Input / Expected Next       | Message    |
|---------------------|---------|-----------------------------|-----------|
| 2026-02-16 10:00:00 | USER   | 17:00 3rd friday happy hour | happy hour |
...
| Current Time        | Actor  | Input / Expected Next       | Message    |
|---------------------|---------|-----------------------------|-----------|
| 2026-02-21 10:00:00 | USER   | 17:00 3rd friday happy hour | happy hour |
...
| Current Time        | Actor  | Input / Expected Next       | Message    |
|---------------------|---------|-----------------------------|-----------|
| 2026-02-16 10:00:00 | USER   | 17:00 5th friday happy hour | happy hour |
...
| Current Time        | Actor  | Input / Expected Next                       | Message    |
|---------------------|--------|---------------------------------------------|------------|
| 2026-03-01 09:00:00 | USER   | 10:00 first friday every 10 days buy ticket | buy ticket |
